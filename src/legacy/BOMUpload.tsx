...
// LEGACY ARCHIVE — kept for historical reference only. The Document Vault uploader
// is the canonical ingestion path. Do not re-import this component into active UI code.
